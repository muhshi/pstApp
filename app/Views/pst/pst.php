            ...
            <div class="row">
                ...
                <div class="tile-body col-md-6">
                    <form action="<?= base_url('/pst/create'); ?>" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?= isset($errors['nama']) ? 'is-invalid' : null; ?>" id="nama" type="text" name="nama" value="<?= old('nama'); ?>" placeholder="Isikan Nama Lengkap">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?= isset($errors['tanggal']) ? 'is-invalid' : null; ?>" id="inputDate" type="text" value="<?= old('tanggal'); ?>" name="tanggal" placeholder="Select Date">
                            ...
                            <?php foreach ($jenis_kelamin as $value) : ?>
                                <div class="form-check">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input <?= isset($errors['jenis_kelamin']) ? 'is-invalid' : null; ?>" type="radio" name="jenis_kelamin" id="Radio<?= $value->id; ?>" value="<?= $value->id; ?>" <?= old('jenis_kelamin' == $value->id) ? 'selected' : null; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?= isset($errors['email']) ? 'is-invalid' : null; ?>" type="email" id="email" value="<?= old('email'); ?>" name="email" placeholder="Isikan Email">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?= isset($errors['tahun_lahir']) ? 'is-invalid' : null; ?>" type="text" value="<?= old('tahun_lahir'); ?>" id="tahun_lahir" name="tahun_lahir">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?= isset($errors['umur']) ? 'is-invalid' : null; ?>" type="number" value="<?= old('umur'); ?>" id="umur" name="umur">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?= isset($errors['alamat']) ? 'is-invalid' : null; ?>" rows="4" name="alamat"><?= old('alamat'); ?></textarea>
                            <div class="invalid-feedback">
                ...
                <div class="tile-body col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?= isset($errors['pekerjaan']) ? 'is-invalid' : null; ?>" name="pekerjaan" id="pekerjaan">
                            ...
                            <?php foreach ($pekerjaan as $value) : ?>
                                <option value="<?= $value->id; ?>" <?= old('pekerjaan' == $value->id) ? 'selected' : null; ?>>
                                    <?= $value->pekerjaan; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?= isset($errors['instansi']) ? 'is-invalid' : null; ?>" type="text" name="instansi" value="<?= old('instansi'); ?>" id="instansi" placeholder="Isikan Nama Instansi">
                        <div class="invalid-feedback">
                            <?= isset($errors['instansi']) ? $errors['instansi'] : null; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control <?= isset($errors['pemanfaatan']) ? 'is-invalid' : null; ?>" name="pemanfaatan_data" id="pemanfaatan_data">
                            ...
                            <?php foreach ($pemanfaatan as $value) : ?>
                                <option value="<?= $value->id; ?>" <?= old('pemanfaatan_data' == $value->id) ? 'selected' : null; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?= isset($errors['layanan']) ? 'is-invalid' : null; ?>" name="layanan" id="layanan">
                            ...
                            <?php foreach ($layanan as $value) : ?>
                                <option value="<?= $value->id; ?>" <?= old('layanan' == $value->id) ? 'selected' : null; ?>>
                                    <?= $value->layanan; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?= isset($errors['data']) ? 'is-invalid' : null; ?>" value="<?= old('data'); ?>" type="text" name="data" id="data" placeholder="Isikan Data Yang Diinginkan Lengkap">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control <?= isset($errors['saran']) ? 'is-invalid' : null; ?>" rows="4" value="<?= old('saran'); ?>" name="saran" placeholder="Isikan Saran Untuk Kami"><?= old('saran'); ?></textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <?php foreach ($kepuasan as $value) : ?>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input <?= isset($errors['kepuasan']) ? 'is-invalid' : null; ?>" type="radio" name="kepuasan" id="inlineRadio<?= $value->id; ?>" value="<?= $value->id; ?>" <?= old('kepuasan' == $value->id) ? 'selected' : null; ?>>
