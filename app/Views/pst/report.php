                        ...
                        <tbody>
                            ...
                            <?php foreach ($pst as $value) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('admin/detail/' . $value->id); ?>" class="btn btn-primary"><span class="fa fa-check"></span> Detail</a>
                                        <a href="<?= base_url('admin/edit/' . $value->id); ?>" class="btn btn-info"><span class="fa fa-pencil"></span> Edit</a>
                                        <form action="<?= base_url('admin/delete/' . $value->id); ?>" method="post" class="d-inline" onsubmit=" return confirm('Yakin Hapus data?')">
                                            <?= csrf_field(); ?>
